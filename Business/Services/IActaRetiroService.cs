...
{
    /// <summary>Obtiene un acta por su ID</summary>
    Task<ActaRetiroDTO?> GetByIdAsync(int actaRetiroId);

    /// <summary>Obtiene un acta por ID de expediente</summary>
    Task<ActaRetiroDTO?> GetByExpedienteIdAsync(int expedienteId);

    /// <summary>Crea una nueva acta de retiro</summary>
