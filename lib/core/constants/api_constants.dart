class ApiConstants {
  ...
  /// EXPEDIENTES VIGILANTE
  static const String expedientesGetAll = '/api/Expedientes';

  /// QR
  static const String consultarQR = '/api/QR/consultar';

  /// CUSTODIA
  static const String custodiaConsultarPrevio = '/api/Custodia/consultar-previo';
  ...
  /// ACTA RETIRO POR EXPEDIENTE
  static const String actaRetiroPorExpediente = '/api/ActaRetiro/expediente';
}
