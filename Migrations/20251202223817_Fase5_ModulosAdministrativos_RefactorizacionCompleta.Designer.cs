...
namespace SisMortuorio.Migrations
{
    ...
    [Migration("20251202223817_Fase5_ModulosAdministrativos_RefactorizacionCompleta")]
    partial class Fase5_ModulosAdministrativos_RefactorizacionCompleta
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SisMortuorio.Data.Entities.AutoridadExterna", b =>
                {
                    ...
                    b.Property<string>("TipoAutoridad")
                        .IsRequired()
                        .HasMaxLength(30)
            ...
            modelBuilder.Entity("SisMortuorio.Data.Entities.DeudaSangre", b =>
                {
                    ...
                    b.Property<int?>("UnidadesAdeudadas")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SisMortuorio.Data.Entities.ExpedienteLegal", b =>
                {
                    ...
                    b.Property<string>("ComisariaOrigen")
                        .HasMaxLength(200)
                        .HasColumnType("nvarchar(200)");

                    b.Property<bool>("DocumentosCompletos")
                        .HasColumnType("bit");
                    ...
                    b.Property<DateTime?>("FechaLimitePendientes")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<string>("FiscaliaOrigen")
                        .HasMaxLength(200)
                        .HasColumnType("nvarchar(200)");

                    b.Property<int?>("JefeGuardiaValidadorID")
                        .HasColumnType("int");

                    b.Property<string>("NombreFiscalRegistrado")
                        .HasMaxLength(300)
                        .HasColumnType("nvarchar(300)");

                    b.Property<string>("NombreMedicoLegista")
                        .HasMaxLength(300)
                        .HasColumnType("nvarchar(300)");

                    b.Property<string>("NombrePoliciaRegistrado")
                        .HasMaxLength(300)
                        .HasColumnType("nvarchar(300)");
                    ...
                    b.Property<bool>("TienePendientes")
                        .HasColumnType("bit");

                    b.Property<int>("UsuarioCreadorID")
                        .HasColumnType("int");

                    b.Property<bool>("ValidadoJefeGuardia")
                        .HasColumnType("bit");
                    ...
                    b.HasIndex("FechaLimitePendientes");

                    b.HasIndex("JefeGuardiaValidadorID");

                    b.HasIndex("TienePendientes");

                    b.HasIndex("UsuarioCreadorID");

                    b.ToTable("ExpedientesLegales");
                });
            ...
            modelBuilder.Entity("SisMortuorio.Data.Entities.SalidaMortuorio", b =>
                {
                    ...
                    b.Property<string>("ResponsableParentesco")
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");
                    ...
                    b.Property<string>("ResponsableTipoDocumento")
                        .IsRequired()
                        .HasMaxLength(20)
                        .HasColumnType("nvarchar(20)");
                    ...
                    b.HasIndex("ResponsableNumeroDocumento");
            ...
            modelBuilder.Entity("SisMortuorio.Data.Entities.ExpedienteLegal", b =>
                {
                    ...
                    b.HasOne("SisMortuorio.Data.Entities.Usuario", "JefeGuardiaValidador")
                        .WithMany()
                        .HasForeignKey("JefeGuardiaValidadorID")
                        .OnDelete(DeleteBehavior.Restrict);
                    ...
                    b.Navigation("JefeGuardiaValidador");
