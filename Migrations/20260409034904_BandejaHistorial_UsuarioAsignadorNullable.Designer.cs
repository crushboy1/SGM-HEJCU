...
namespace SisMortuorio.Migrations
{
    ...
    [Migration("20260409034904_BandejaHistorial_UsuarioAsignadorNullable")]
    partial class BandejaHistorial_UsuarioAsignadorNullable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SisMortuorio.Data.Entities.Bandeja", b =>
                {
                    ...
                    b.Property<string>("DetalleMantenimiento")
                        .HasMaxLength(500)
                        .HasColumnType("nvarchar(500)");
                    ...
                    b.Property<DateTime?>("FechaEstimadaFinMantenimiento")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<string>("ResponsableMantenimiento")
                        .HasMaxLength(200)
                        .HasColumnType("nvarchar(200)");
                    ...
                    b.Property<int?>("UsuarioRegistraMantenimientoID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SisMortuorio.Data.Entities.Bandeja", b =>
                {
                    ...
                    b.HasOne("SisMortuorio.Data.Entities.Usuario", "UsuarioRegistraMantenimiento")
                        .WithMany()
                        .HasForeignKey("UsuarioRegistraMantenimientoID")
                        .OnDelete(DeleteBehavior.Restrict);
                    ...
                    b.Navigation("UsuarioRegistraMantenimiento");
                });
